    ...
    <div className="min-h-screen bg-background text-foreground font-sans selection:bg-cyan-500 overflow-x-hidden">
      ...
      <nav className="relative z-50 flex justify-between items-center p-6 border-b border-white/5 backdrop-blur-sm">
        ...
        <div className="hidden md:flex space-x-8 text-sm uppercase tracking-widest text-gray-400 font-medium">
          <Link href="/#assets">
            <a className="hover:text-cyan-400 transition-colors duration-300">Assets</a>
          </Link>
          <Link href="/forge">
            <a className="hover:text-cyan-400 transition-colors duration-300">The Forge</a>
          </Link>
          <Link href="/pricing">
            <a className="hover:text-cyan-400 transition-colors duration-300">Pricing</a>
          </Link>
        </div>
