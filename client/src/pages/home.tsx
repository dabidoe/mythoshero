...
export default function Home() {
  return (
    <div className="min-h-screen bg-background text-foreground font-sans selection:bg-cyan-500 overflow-x-hidden">
      {/* Background Ambience */}
      ...
      {/* Navigation */}
      <nav className="relative z-50 flex justify-between items-center p-6 border-b border-white/5 backdrop-blur-sm">
        <div className="text-2xl font-bold font-heading tracking-tighter text-cyan-500">MythOS</div>
        <div className="hidden md:flex space-x-8 text-sm uppercase tracking-widest text-gray-400 font-medium">
          <a href="#assets" className="hover:text-cyan-400 transition-colors duration-300">Assets</a>
          <a href="#forge" className="hover:text-cyan-400 transition-colors duration-300">The Forge</a>
          <a href="#pricing" className="hover:text-cyan-400 transition-colors duration-300">Pricing</a>
        </div>
        <button className="bg-white text-black px-6 py-2 rounded-full font-bold hover:bg-cyan-400 transition-colors duration-300 shadow-[0_0_20px_rgba(255,255,255,0.3)] hover:shadow-[0_0_20px_rgba(34,211,238,0.5)]">
          Launch App
        </button>
      </nav>
